...
/**
 * toggleplay - Creates an action named "TOGGLEPLAY" with
...
/**
 * play - Creates an action named "PLAY" with
 * the required data to execute the reducer action.
 *
 * @return {ActionCreator} the action creator
 */
...
/**
 * stop - Creates an action named "STOP" with
 * the required data to execute the reducer action.
 *
 * @return {ActionCreator} the action creator
 */
...
/**
 * playing - Creates an action named "PLAYING" with
 * the required data to execute the reducer action.
 *
 * @param {object} audioStatus The currect status (time elapsed, etc.) of the dom player
 * @return {ActionCreator} the action creator
 */
